  ...
  new Vue({
	...
	data: {
        ...
        この二つの言葉 が組み合わさり、ブランド名「TOKIO インカラミ」が誕生しました。<br>
		...
		hiddenBody: `
        日本国内にとどまらず、欧米・アジアをはじめ世界でも、日本から来た 「世界一のトリートメント」と評されています。<br>
          ...
          髪の内部からしっかりケアする納得の補修力、そして持続力、軽くて柔らかい独特の質感。
           ...
           それが髪の根本的な悩み解決にもつながることを信じて・・・<br>こうした想いを持って開発したのが、<strong>TOKIO IE ホームケアシリーズです。
        `,
