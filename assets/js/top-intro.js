  ...
  new Vue({
	...
	data: {
        ...
        毛髪の中に“イン”して、補修成分を”カラミ”合わせるから「インカラミ」。<br>
        この二つの言葉が組み合わさり、ブランド名「TOKIO インカラミ」が誕生しました。<br>
        髪の主成分であるケラチンを補給し、髪を徹底的に補修します。<br>
        そんな本格的サロンメニューをご自宅で味わえるホームケア・シャンプー&トリートメントが<br>TOKIO IE(トキオアイイー)です。 
        `,
